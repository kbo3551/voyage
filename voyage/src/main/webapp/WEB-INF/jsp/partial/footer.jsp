...
<body>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> not All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i>장군멍군 <!--  by <a href="https://colorlib.com" target="_blank">Colorlib</a> -->
