		                ...
		                <div class="col-md-6">
		                    <div class="box-for overflow">                         
		                        <div class="col-md-12 col-xs-12 login-blocks">
		                            ...
		                            <br>
		                            <c:choose>
		                            	<c:when test="${param.idChecking == 'id'}">
                                	...
                                	<form name="AddAdmin" action="${pageContext.request.contextPath}/addAdmin" method="post">
                                		<div class="form-group"> 
		                                    ...
		                                    <input type="text" class="form-control" id="id" name="id" placeholder="아이디입력 *" <c:if test="${param.idChecking != 'id'}">value="${admin.getAdminId()}"</c:if>>
		                                </div>
		                                <div class="form-group">
										...
										<div class="form-group">
		                                    ...
		                                    <input type="text" class="form-control" placeholder="성 *" id="firstname" name="firstname" value="${admin.getAdminFirstName()}">
		                                </div>
		                                <div class="form-group">
		                                    <label for="lastname" class="text-primary">Last name</label>
		                                    <input type="text" class="form-control" placeholder="이름 *" id="lastname" name="lastname" value="${admin.getAdminLastName()}">
		                                </div>
		                                <div class="form-group">
		                                    <label for="phone" class="text-primary">Phone</label>
		                                    <input type="tel" class="form-control" placeholder="전화번호 ( - 빼고 입력해주세요) *" id="phone" name="phone" value="${admin.getAdminPhone()}">
		                                </div>
		                                <div class="form-group">
		                                    <label for="email" class="text-primary">Email</label>
		                                    <input type="email" class="form-control" placeholder="이메일 *" id="email" name="email" value="${admin.getAdminEmail()}">
		                                </div>
		                                <div class="form-group">
		                                    <label for="socialsecuritynumber" class="text-primary">주민등록번호</label>
		                                    <div>
		                                ...
		                                <div class="form-group">
		                                    <label for="address" class="text-primary">Post Code</label>
		                                ...
		                                <div class="text-center">
	                                   		<button type="button" class="btn" style="background: linear-gradient(0deg, rgba(0,172,238,1) 0%, rgba(2,126,251,1) 100%);
