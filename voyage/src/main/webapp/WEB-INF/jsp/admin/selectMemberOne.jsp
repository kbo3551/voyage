					...
					<div class="card flex-fill">
						...
						<div class="clear"> 
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <label>회원ID</label>
                                    <input class="form-control" type="text" readonly="readonly" value="${member.memberId}">
                                </div>
                                <div class="form-group">
                                    <label>이름(성)</label>
                                     <input class="form-control" type="text" readonly="readonly" value="${member.memberFirstName}">
                                </div> 
                                <div class="form-group">
                                    <label>이름</label>
                                  	<input class="form-control" type="text" readonly="readonly" value="${member.memberLastName}">
                                </div> 
                                <div class="form-group">
                                    <label>닉네임</label>
                                     <input class="form-control" type="text" readonly="readonly" value="${member.memberNickname}">
                                </div> 
                            </div>
                            <div class="col-sm-10">
                                <div class="form-group">
                                  <label>핸드폰번호</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.memberPhone}">
                             	</div>
                            	  <div class="form-group">
                                  <label>우편번호</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.memberEmail}">
                             	</div>
                            	  <div class="form-group">
                                  <label>회원 LV</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.memberLevel}">
                             	</div>
                             	                                <div class="form-group">
                                  <label>회원 상태</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.memberActive}">
                             	</div>
                            	  <div class="form-group">
                                  <label>가입일자</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.createDate}">
                                  <div>
                                  </div>
                             	</div>
                            	  <div class="form-group">
                                  <label>수정일자</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.updateDate}">
                             	</div>
                     	         <div class="form-group">
                                  <label>마지막 접속 날짜</label>
                                  <input class="form-control" type="text" readonly="readonly" value="${member.lastLogin}">
                             	</div>
                        ...
                        <div class="card flex-fill">
                        	...
                        	<div class="col-sm-20 col-sm-offset-1" style="text-align: center;">
                             <br>
                             <a href="${pageContext.request.contextPath}/admin/a?a=1" class='btn btn-finish btn-primary'>수정</a>
                         </div>
	</div>
	</div>
</div>			
