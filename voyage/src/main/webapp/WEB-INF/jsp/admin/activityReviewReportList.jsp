    ...
    <!-- adminKit : 끝 -->
		...
		<main class="content">
			<div class="container-fluid p-0">
				...
				<h1 class="h3 mb-3"><strong>체험후기</strong> 신고 관리</h1>
				
				<div class="row">
					<div class="col-12 col-lg-8 col-xxl-9 d-flex">
						<div class="card flex-fill">
							<div class="card-header">
								<h3 class="h3 mb-3">신고 목록</h3>
							</div>
							<table class="table table-hover my-0">
								...
								<tbody> 
									<c:forEach items="${reportList}" var="r" >
										<tr>
									        <td>${r.actrReportNo}</td>
									        <td>${r.activityReviewNo}</td>
									        <td>${r.memberId}</td>
             ...
             <div class="container">
                <ul class="nav justify-content-center bg-light">
                   <c:if test="${beginRow > (ROW_PER_PAGE * 10)}">
                      <li><a href="${pageContext.request.contextPath}/admin/activityReviewReportList?currentPage=${pageNo-1}">&lt;</a></li>
                   </c:if>
                   ...
                   <c:forEach var="f" begin="${pageNo}" end="${pageNo + 9}">
                      <c:if test="${not doneLoop}">
                         <c:choose>
                            ...
                            <c:otherwise>
                               <li><a class="nav-link active" href="${pageContext.request.contextPath}/admin/activityReviewReportList?currentPage=${f}">${f}</a></li>
                            </c:otherwise>
                         </c:choose>
                   ...
                   <c:if test="${currentPage + 10 <= lastPage}">
                      <li><a class="nav-link active" href="${pageContext.request.contextPath}/admin/activityReviewReportList?currentPage=${pageNo+10}">&gt;</a></li>
                   </c:if>
                </ul>
          </div> 
    <!-- adminFooter : 시작 -->
