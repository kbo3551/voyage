            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <!-- Form -->
                        <form method="post" class="form-contact contact_form mb-80" action="${pageContext.request.contextPath}/addReport" id="reportForm">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" id="sendReportBtn" class="button button-contactForm boxed-btn">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
