            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <!-- Form -->
                        <form method="post" class="form-contact contact_form mb-80" action="${pageContext.request.contextPath}/addAccomReviewReport" id="accomReviewReportForm">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                    	<input class="form-control error" name="accomReviewNo" id="accomReviewNo" type="text" value="${param.accomReviewNo}" readonly="readonly">
                                    </div>
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" id="sendAccrReportBtn" class="button button-contactForm boxed-btn">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
